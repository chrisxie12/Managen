...
const requirePermission = (permission) => {
    return async (req, res, next) => {
        try {
            ...
            // Skip isolation check for superadmins
            const userRole = user.roleName || (await authService.getUserById(user.userId || user.id)).role_id; 
            // Better to have role name in the user object/JWT
