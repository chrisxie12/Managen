...
import {
  ...
  Sun, Moon, Shield, Zap as ZapIcon, PlayCircle, Star, ArrowUpRight,
} from "lucide-react";
  ...
  const features = [
    {
      ...
      desc: "One-tap daily attendance with automatic parent notifications.",
      color: "#3B82F6",
    },
    {
      icon: Wallet,
      title: "Smart Fee Collection",
      desc: "Automated reminders, payment tracking, and reconciliation.",
      color: "#10B981",
    },
    {
      icon: BarChart3,
      title: "Exam & Grades",
      desc: "WAEC/BECE templates, automatic grading, instant reports.",
      color: "#F59E0B",
    },
    {
      icon: MessageSquare,
      title: "WhatsApp Reports",
      desc: "Parents get real-time updates without manual work.",
      color: "#8B5CF6",
    },
    {
      icon: TrendingUp,
      title: "Performance Analytics",
      desc: "Visual dashboards for tracking school metrics in real-time.",
      color: "#EC4899",
    },
    {
      icon: Shield,
      title: "Bank-Grade Security",
      desc: "Encrypted data, isolated by school, daily backups.",
      color: "#EF4444",
    },
  ];
  ...
  return (
    ...
    >
      <style>{`
        ...
        .glow-amber { box-shadow: 0 0 20px rgba(255, 186, 8, 0.2); }
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="reveal reveal-1 text-5xl md:text-6xl font-bold leading-tight"
                style={{ color: COLORS.NAVY }}>
                School Management That Just Works
              </h1>

              <p className="reveal reveal-2 text-lg" style={{ color: COLORS.MUTED, maxWidth: "500px" }}>
                Stop juggling spreadsheets. Managen handles attendance, fees, exams, and parent communication — all in one place. Trusted by 340+ schools.
              </p>
      ...
      <section id="features" className="py-24 px-6"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm font-semibold" style={{ color: COLORS.AMBER }}>EVERYTHING YOU NEED</p>
            <h2 className="text-4xl font-bold mt-4" style={{ color: COLORS.NAVY }}>
              Built for real schools
            </h2>
            <p className="mt-4 text-lg" style={{ color: COLORS.MUTED, maxWidth: "600px", margin: "1rem auto" }}>
              Every feature designed for how African schools actually work.
            </p>
          </div>
      ...
      <section className="py-16 px-6" style={{ background: `linear-gradient(135deg, ${COLORS.NAVY}, ${COLORS.NAVY_LIGHT})` }}>
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg" style={{ color: "rgba(248,249,250,0.8)" }}>
            Join 340+ schools already using Managen to run their operations.
          </p>
          <button
            onClick={() => navigate("/auth?mode=signup")}
          ...
          <p className="text-sm" style={{ color: "rgba(248,249,250,0.6)" }}>
            No credit card required. 7-day free trial. All features included.
          </p>
        </div>
      </section>
