  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 style={{ fontWeight: 800, fontSize: "1.5rem", color: PLUM }}>Students</h1>
      ...
      <div className="flex items-center justify-center min-h-[400px] rounded-[24px]" style={{ background: "white", border: "1px solid rgba(56,25,50,0.07)" }}>
        <div className="text-center p-8">
          ...
          <p style={{ color: PLUM, fontSize: "1.1rem", fontWeight: 600, marginBottom: "0.3rem" }}>No Students Yet</p>
          <p style={{ color: MUTED, fontSize: "0.85rem", marginBottom: "1.5rem" }}>Add your first student to get started.</p>
          <button onClick={() => navigate("/dashboard/students")} className="px-6 py-2.5 rounded-full text-sm" style={{ background: PLUM, color: "#FFF3E6" }}>
