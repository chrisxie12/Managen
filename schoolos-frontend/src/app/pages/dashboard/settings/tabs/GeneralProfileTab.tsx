...
export function GeneralProfileTab({ role }: Props) {
  ...
  if (loading) {
    return <div className="flex items-center justify-center min-h-[40vh]"><Loader2 className="animate-spin" size={24} color={PLUM} /></div>;
  }
          ...
          <FormField label="Favicon">
            <div onClick={() => faviconInputRef.current?.click()}
              ...
              {form.favicon_url ? (
                ...
                <div>
                  <Upload size={24} color={MUTED} className="mx-auto mb-2" />
                  <p className="text-xs font-medium" style={{ color: PLUM }}>Upload Favicon</p>
