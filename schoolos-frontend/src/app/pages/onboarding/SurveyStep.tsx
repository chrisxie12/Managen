...
export function SurveyStep({ onNext, onBack }: { onNext: (answers: SurveyAnswers) => void; onBack: () => void }) {
  ...
  if (personalizing) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        <div className="w-10 h-10 border-4 border-t-transparent rounded-full animate-spin mb-6" style={{ borderColor: INDIGO, borderTopColor: "transparent" }} />
  ...
  return (
    <div>
      ...
      <div className="rounded-2xl p-6 md:p-8" style={{ background: "#ECEAF8" }}>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: isSelected ? `2px solid ${INDIGO}` : "2px solid transparent",
                      boxShadow: isSelected ? `0 4px 16px rgba(99,102,241,0.15)` : "none",
                    }}
                  >
                    <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0"
                      style={{
                        background: isSelected ? INDIGO : "rgba(0,0,0,0.08)",
                        border: isSelected ? "none" : "2px solid rgba(0,0,0,0.12)",
                      }}>
