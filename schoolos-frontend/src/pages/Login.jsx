    ...
    <div className="min-h-screen flex overflow-hidden font-body" style={{ background: MILK }}>
      ...
      <div className="hidden lg:flex w-[42%] p-16 flex-col justify-between relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${PLUM} 0%, ${PLUM_LIGHT} 100%)` }}>
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            ...
            >
              The standard for <br/> 
              <span style={{ fontStyle: 'italic', color: 'rgba(255,243,230,0.7)' }}>Institutional</span> <br/>
              excellence.
            </motion.h2>
            <div className="flex items-center gap-4 text-white/40 text-xs font-black uppercase tracking-[0.2em]">
           ...
           <div className="bg-white/5 border border-white/10 rounded-[32px] p-8 backdrop-blur-xl max-w-sm">
              <div className="flex items-center gap-4 mb-6">
                 ...
                 <div>
                    ...
                    <div className="text-white/40 text-[10px] font-black uppercase tracking-widest">256-Bit SSL Encrypted</div>
                 </div>
              </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-24 relative overflow-y-auto">
        <div className="max-w-md w-full mx-auto py-12">
          ...
          <div className="mb-12">
            <h1 className="text-4xl font-black tracking-tight mb-3" style={{ color: PLUM }}>Welcome back.</h1>
            <p style={{ color: MUTED, fontWeight: 600 }} className="leading-relaxed">Enter your administrative credentials to access your node.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <AnimatePresence>
              {detectedSchool && (
                ...
                >
                  ...
                  <span className="text-[11px] font-black uppercase tracking-widest" style={{ color: PLUM_LIGHT }}>{detectedSchool}</span>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-widest ml-1" style={{ color: MUTED }}>Administrative Email</label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                <label className="text-[10px] font-black uppercase tracking-widest" style={{ color: MUTED }}>Security Key</label>
            ...
            <div className="relative py-4">
               ...
               <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest"><span className="px-4 text-slate-400" style={{ background: MILK }}>Or Secure Entry</span></div>
            </div>
